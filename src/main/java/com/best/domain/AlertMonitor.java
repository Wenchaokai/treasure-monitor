...
public class AlertMonitor implements Serializable {
	...
	private Integer alertMonitorWareHouseId;
	...
	public Integer getAlertMonitorWareHouseId() {
		return alertMonitorWareHouseId == null ? 0 : alertMonitorWareHouseId;
	}

	public void setAlertMonitorWareHouseId(Integer alertMonitorWareHouseId) {
		this.alertMonitorWareHouseId = alertMonitorWareHouseId;
	}
